...
void trap_init()
{
   ...
   */
	extern uint32_t page_fault_14; 
	extern uint32_t kbd_handler_33;
	extern uint32_t timer_handler_32;
	/* Keyboard interrupt setup */
	SETGATE(idt[32], 1, GD_KT, &timer_handler_32,3);
	/* Timer Trap setup */
	SETGATE(idt[33], 1, GD_KT, &kbd_handler_33, 3);
	/* page fault */
	SETGATE(idt[T_PGFLT], 1, GD_KT, &page_fault_14, 3);
  /* Load IDT */
